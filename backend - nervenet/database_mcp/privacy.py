...
class PrivacyEngine:
    """Server-side utility to tokenize sensitive PII in database results and detokenize input queries."""
    def __init__(self):
        self.value_to_token = {}
        self.token_to_value = {}
    ...
    def get_or_create_token(self, prefix: str, value: Any) -> str:
        ...
        # Clean trailing decimal points for numeric fields
        ...
        # Generate token in the format <//PREFIX-UUID//> using 12 characters of UUID
    ...
    def encrypt_record(self, record: Any) -> Any:
        """Recursively encrypt sensitive fields in a dictionary record or a list of records."""
    ...
    def decrypt_value(self, val: Any) -> Any:
        """Decrypt a single token back to its original value."""
...
# Global singleton instance of the privacy engine for the server
